...
int = 20; -- INTENSIDAD DE MOVIMIENTO DE CAMARA, mas = intenso
...
dadx1 = 50; --Eje X de camara de dad (Menos = Izquierda  Mas = Derecha)
dady1 = 0; --Eje Y de camara de dad (Menos = Arriba  Mas = Abajo)
bfx1 = 20; --Eje X de camara de bf (Menos = Izquierda  Mas = Derecha)
bfy1 = -50; --Eje Y de camara de bf (Menos = Arriba  Mas = Abajo)
gfx1 = 180; --Eje X de camara de gf (Menos = Izquierda  Mas = Derecha) Recomiendo usarlo para otra posicion de camara extra si gf no canta
