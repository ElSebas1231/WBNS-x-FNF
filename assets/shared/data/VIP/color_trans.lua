...
function onStepHit()
    if curStep == 383 or curStep == 895 then
        doTweenX('mc1', 'mc1', mc1, 0.8, 'smoothStepIn')
        doTweenX('mc2', 'mc2', mc2, 0.8, 'smoothStepIn')
        doTweenX('mc3', 'mc3', mc3, 0.8, 'smoothStepIn')
        doTweenY('mc4', 'mc1', 0, 0.8, 'smoothStepIn')

        doTweenX('lc1', 'lc1', lc1, 0.8, 'smoothStepIn')
        doTweenX('lc2', 'lc2', lc2, 0.8, 'smoothStepIn')
        doTweenX('lc3', 'lc3', lc3, 0.8, 'smoothStepIn')
        doTweenY('lc4', 'lc1', 0, 0.8, 'smoothStepIn')
    elseif curStep == 511 then
        doTweenX('mc1', 'mc1', 0, 0.5, 'smoothStepIn')
        doTweenX('mc2', 'mc2', 0, 0.5, 'smoothStepIn')
        doTweenX('mc3', 'mc3', 0, 0.5, 'smoothStepIn')
        doTweenY('mc4', 'mc1', 1, 0.5, 'smoothStepIn')

        doTweenX('lc1', 'lc1', 0, 0.5, 'smoothStepIn')
        doTweenX('lc2', 'lc2', 0, 0.5, 'smoothStepIn')
        doTweenX('lc3', 'lc3', 0, 0.5, 'smoothStepIn')
        doTweenY('lc4', 'lc1', 1, 0.5, 'smoothStepIn')
    end
end