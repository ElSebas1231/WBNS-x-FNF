...
zoomextra = 0.7; --Coloca con cuanto zoom extra quieres que inicie la cancion, el predeterminado de extra es 0 (solo el que tiene el stage)
...
function onUpdatePost()
    setProperty('iconP1.y',(downscroll and 50 or 480))
