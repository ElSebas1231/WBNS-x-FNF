...
class FunkinSoundTray extends FlxSoundTray
{
	...
	public function new()
	{
		...
		bg = new Bitmap(Assets.getBitmapData('assets/shared/images/soundtray/volumebox.png'));
		...
		for (i in 1...11)
		{
			bar = new Bitmap(Assets.getBitmapData("assets/shared/images/soundtray/bars_" + i+'.png'));
			bar.x = 9;
			bar.y = 5;
