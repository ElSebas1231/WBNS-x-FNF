...
class DiscordClient
{
	...
	private static final _defaultID:String = "1242619265581056063";
	...
	public static function changePresence(?details:String = 'Iniciando...', ?state:Null<String>, ?songPortrait:String = 'icon', ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float, ?button1Label:String, ?button1Url:String, ?button2Label:String, ?button2Url:String)
	{
		...
		presence.button1Label = button1Label;
		presence.button1Url = button1Url;

		presence.button2Label = button2Label;
		presence.button2Url = button2Url;

		if(presence.button1Label == null) {
			presence.button1Label = "¡Descarga el mod dando clic!";
		}

		if(presence.button2Label == null) {
			presence.button2Label = "Cuenta de Twitter/𝕏 del mod";
		}
		
		if(presence.button1Url == null) {
			presence.button1Url = "https://gamejolt.com/games/wbnsxfnfmod/904827";
		}

		if(presence.button2Url == null) {
			presence.button2Url = "https://x.com/WBNSxFNFmod";
		}
