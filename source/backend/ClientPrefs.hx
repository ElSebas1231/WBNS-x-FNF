...
@:structInit class SaveVariables {
	...
	public var hideNoteSplashes:Bool = false;
	public var lowQuality:Bool = false;
	public var shaders:Bool = true;
	public var cacheOnGPU:Bool = #if !switch false #else true #end; //From Stilic
	public var framerate:Int = 70;
	...
	public var comboOffset:Array<Int> = [-210, -90, -160, -30];
	public var comboOffsetDefault:Array<Int> = [-210, -90, -160, -30];
