...
class NotesSubState extends MusicBeatSubstate
{
	...
	public function new() {
		...
		var tipX = 20;
		var tipY = 660;
		var tip:FlxText = new FlxText(tipX, tipY, 0, "Presiona RESET para resetear la parte seleccionada.", 16);
	...
	function updateTip()
	{
		tipTxt.text = 'Mantén ' + (!controls.controllerMode ? 'Shift' : 'Left Shoulder Button') + ' + presionado RESET para resetear completamente la parte seleccionada.';
	}
