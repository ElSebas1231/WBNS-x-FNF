...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		DiscordClient.changePresence("Menú de Freeplay", null);
		#end
		...
		var leText:String = "Presiona SPACE para escuchar la Song / Presiona CTRL para abrir el Menú de Gameplay Changers / Presiona RESET para borrar Puntos y Presición.";
		bottomString = leText;
		var size:Int = 16;
	...
	override function update(elapsed:Float)
	{
		...
		else if(FlxG.keys.justPressed.SPACE || FlxG.mouse.justPressedMiddle)
		{
		...
		else if (controls.ACCEPT || FlxG.mouse.justPressedRight && !player.playingMusic)
		{
			persistentUpdate = false;
